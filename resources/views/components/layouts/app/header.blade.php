...
<div
    ...
    class="fixed bottom-4 right-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-4 py-2 rounded-lg shadow-lg z-50 text-sm font-bold flex items-center gap-2"
    style="display: none;"
>

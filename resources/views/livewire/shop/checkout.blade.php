                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                @foreach($items as $item)
                                    <div wire:key="{{ $item->id }}" class="flex justify-between items-center p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                        <div>
                            ...
                            <!-- Total -->
                            <div class="flex justify-end items-center pt-4 border-t border-zinc-200 dark:border-zinc-700">

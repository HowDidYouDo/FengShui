    ...
    <div
        ...
        <div class="relative hidden md:block">
            <div class="relative w-full aspect-square flex items-center justify-center">
                <div
                    class="absolute w-4/5 h-4/5 bg-gradient-to-tr from-brand-blue-light to-white rounded-full shadow-2xl shadow-blue-100/50 animate-pulse"
                ...
                <div
                    class="absolute top-[20%] right-[20%] p-4 bg-white rounded-2xl shadow-lg animate-bounce text-brand-orange"
                ...
                <div
                    class="absolute bottom-[30%] left-[20%] p-4 bg-white rounded-2xl shadow-lg animate-bounce text-brand-blue"
